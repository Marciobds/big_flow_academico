...
return array('basePath' => dirname(__FILE__).DIRECTORY_SEPARATOR.'..', 'name' => 'Big Flow Acadêmico',
...
// If removed, Gii defaults to localhost only. Edit carefully to taste.
	...
	'disciplina'),
// application components
'components' =>array('user' =>array(// enable cookie-based authentication
	'allowAutoLogin' => true,
	),
...
'db' =>array('connectionString' => 'mysql:host=localhost;dbname=bigflow',
	'emulatePrepare' => true,
	'username'       => 'root',
	'password'       => 'root',
	'charset'        => 'utf8',
