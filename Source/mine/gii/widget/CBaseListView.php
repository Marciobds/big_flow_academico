...
abstract class CBaseListView extends CWidget
{
	...
	{
		$emptyText=$this->emptyText===null ? Yii::t('zii','Nenhum registro encontrado.') : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		if($this->enablePagination)
		{
			...
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Mostrando registros {start} até {end} de 1 registros.|Mostrando registros {start} até {end} de {count} registros.',$total);
		...
		{
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Ao todo 1 registro.|Ao todo {count} registros.',$count);
			echo strtr($summaryText,array(
				'{count}'=>$count,
				'{start}'=>1,
				'{end}'=>$count,
